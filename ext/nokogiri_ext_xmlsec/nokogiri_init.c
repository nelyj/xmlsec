...
void Init_Nokogiri_ext() {
  ...
  rb_define_method(rb_cNokogiri_XML_Document, "sign_with_certificate",    sign_with_certificate, 4);
  ...
  rb_define_method(rb_cNokogiri_XML_Node,     "set_attribute_id_hack",         set_attribute_id_hack, 1);
